...
DN_EXTERN void native_mark_autoreleasereturn_object(id object);

DN_EXTERN const uint16_t *native_convert_nsstring_to_utf16(NSString *string, NSUInteger *length);
...
DN_EXTERN bool PassObjectToCUseDynamicLinking(Dart_Handle h, void *pointer);
